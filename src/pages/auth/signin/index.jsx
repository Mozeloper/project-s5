    ...
    <div className="flex min-h-screen h-screen justify-center items-center bg-gray-900 md:p-4 p-5">
      {!pendingApproval ? (
        ...
        <div className="bg-white md:w-[500px] w-full min-h-[300px] md:h-auto md:pt-16 rounded-lg md:p-6 p-5">
          Hello <span className="text-primary">Beloved</span>, <br /> You are
          unable to access the portal right now because account approval is
          still pending. Once approved, you will receive a mail, after which you
          can login. Thanks for your patience. God bless.
        </div>
      )}
    </div>
  );
