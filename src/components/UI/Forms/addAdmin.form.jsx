...
import { useWorkersNames } from "../../../hooks/useWorkers";

export default function AddAdminFormControl() {
  const formpayload = {};
  const { data: workerName, isError, isLoading } = useWorkersNames();
  ...
  return (
    <>
      ...
      >
        ...
        <SearchBoxIndex 
          searchArray={workerName && workerName?.Data} 
          // bg={'bg-transparent'} 
          textColor="#CBCBCB" 
      ...
      <form className="relative">
        <div className="relative z-0 w-full mb-6 group">
          {/* <input
            ...
            name="worker_name"
            id="worker_name"
            className="block py-2.5 px-0 w-full text-gray-900 text-base bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-primary peer"
            placeholder=" "
            required
          />
          <label
        ...
        <div className="relative z-0 w-full mb-6 group">
          ...
          <select
            id="large"
            className="block w-full px-4 py-3 text-base text-gray-900 border border-primary rounded-lg bg-gray-50 focus:ring-primary focus:border-primary"
          >
