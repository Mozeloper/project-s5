...
export async function getAllAdminDashboardAnalytics() {
    try {
        const allAdminDashboardAnalytics = await api.get(`${baseUrl}${appUrls.ADMINS_DASHBOARD_ANALYTICS}`)
...
export async function getAllNewConvertDashboardAnalytics() {
    try {
        const allNewConvertDashboardAnalytics = await api.get(`${baseUrl}${appUrls.NEWCONVERT_DASHBOARD_ANALYTICS}`)
        const NewConvertDashboardAnalytics = await allNewConvertDashboardAnalytics?.data
...
export async function getAllDtiDashboardAnalytics() {
    try {
        const allDtiDashboardAnalytics = await api.get(`${baseUrl}${appUrls.DTI_ADMINS_DASHBOARD_ANALYTICS}`)
...
export async function getAllMinistryDashboardAnalytics() {
    try {
        const allMinistryDashboardAnalytics = await api.get(`${baseUrl}${appUrls.MINISTRY_ADMINS_DASHBOARD_ANALYTICS}`)
        const MinistryDashboardAnalytics = await allMinistryDashboardAnalytics?.data
...
export async function getPersonalAnalytics(AnalyticsId) {
    try {
        const allMinistryDashboardAnalytics = await api.get(`${baseUrl}${appUrls.PERSONAL_ANALYTICS_BY_ID}/${AnalyticsId}`)
        const MinistryDashboardAnalytics = await allMinistryDashboardAnalytics?.data
        return MinistryDashboardAnalytics
    } catch (error) {
        throw new Error(error.message || error)
