export const appUrls = {
  ...
  //New converts (soul)
  GET_ALL_New_Convert: "api/NewConvertAdmin/get-all-new-convants-for-newconvertadmin",

  //Ministry
  GET_ALL_MINISTRY_URL: "/api/MinistryAdmin/get-all-new-convert-for-ministry-admin",
