...
import {
  require_prop_types
} from "./chunk-Y4BVASWM.js";
import {
  require_react_dom
} from "./chunk-6DLUDZVL.js";
import "./chunk-YLEMBMEX.js";
import {
  require_react
...
var Person_default = createSvgIcon((0, import_jsx_runtime57.jsx)("path", {
...
var _excluded38 = ["alt", "children", "className", "component", "imgProps", "sizes", "src", "srcSet", "variant"];
...
function useLoaded({
  ...
  const [loaded, setLoaded] = React86.useState(false);
  React86.useEffect(() => {
    if (!src && !srcSet) {
      return void 0;
    }
...
var Avatar = React86.forwardRef(function Avatar2(inProps, ref) {
  const props = useThemeProps2({
    props: inProps,
    name: "MuiAvatar"
  });
  ...
  if (hasImgNotFailing) {
    children = (0, import_jsx_runtime58.jsx)(AvatarImg, _extends({
      alt,
      src,
      srcSet,
      sizes,
    ...
    children = (0, import_jsx_runtime58.jsx)(AvatarFallback, {
      ownerState,
      className: classes.fallback
    });
  }
  return (0, import_jsx_runtime58.jsx)(AvatarRoot, _extends({
    as: component,
    ownerState,
    className: clsx_m_default(classes.root, className),
    ref
